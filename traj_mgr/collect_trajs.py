...
def process_single_trajectory(
    ...
    try:
        ...
        traj["model_switch_idx"] = traj["model_switch_idx"] if "model_switch_idx" in traj else 0
...
def main(
    ...
    with ThreadPoolExecutor(max_workers=workers) as executor:
        ...
        future_to_folder = {
            executor.submit(
                process_single_trajectory, folder, traj_dir, eval_dir, transform_traj, resolved_only
            ): folder
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        "--resolved_only",
        action="store_true",
        help="Only include resolved trajectories. Default: False",
    )
